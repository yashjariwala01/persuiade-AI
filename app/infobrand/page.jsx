    ...
    <main className='container flex flex-col w-full min-h-screen justify-center items-center'>
        <div className='flex flex-col w-2/3  justify-center items-center space-y-8 mt-10'>
            ...
            <div className='bg-[#E0E0E0] rounded-xl p-8 md:w-[560px] md:h-fit'>
                ...
                <button onClick={()=> setBrandManual(true)} className='bg-[#ED0A97] rounded-lg p-2 md:w-fit self-center flex gap-1'><p className='text-white text-xs self-center'>Past Campaigns & Brand Manual</p><RxDividerVertical className='h-10 w-16'/>
                 <TfiUpload className='bg-white rounded-md text-[#ED0A97] w-[59px] h-[30px] p-1 place-self-center'/></button>

                <p className='text-xs self-center'>File formats: jpg, pdf, doc, ppt, html</p>
                </div>
            </div>

            <div className='bg-white rounded-xl p-8 md:w-[560px] md:h-fit'>
            ...
            <div className='flex justify-between items-center w-full md:w-3/5'>
                ...
                <button className='bg-[#BFBFBF] p-2'>NEXT</button>
            </div>
